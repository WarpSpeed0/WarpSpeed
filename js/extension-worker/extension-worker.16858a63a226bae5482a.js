...
const EXTENSION_INIT_TIMEOUT_MS = 30000;
    ...
    dispatch.waitForConnection.then(() => {
      dispatch.call('extensions', 'allocateWorker').then(async x => {
        ...
        try {
          ...
          await withTimeout(this.firstRegistrationPromise, EXTENSION_INIT_TIMEOUT_MS, "Timed out waiting for sandboxed extension ".concat(extension, " to register."));
...
/******/ });
//# sourceMappingURL=extension-worker.16858a63a226bae5482a.js.map