...
const actuallyLoadServiceWorker = () => {
  navigator.serviceWorker.getRegistration("").then(async registration => {
    ...
    _lib_log__WEBPACK_IMPORTED_MODULE_0__["default"].error('sw cleanup error', err);
  });
};
const loadServiceWorker = () => {
  if ('serviceWorker' in navigator && !loaded) {
    loaded = true;
...
const messages = Object(react_intl__WEBPACK_IMPORTED_MODULE_5__["defineMessages"])({
  defaultTitle: {
    ...
    "defaultMessage": "Animators dream"
  }
});
...
let addonReloadPromptPending = false;
const requestAddonReload = () => {
  if (addonReloadPromptPending) {
    return;
  }
  addonReloadPromptPending = true;
  // eslint-disable-next-line no-alert
  const shouldReload = window.confirm('WarpSpeed needs to reload to apply changes. Reload now?');
  addonReloadPromptPending = false;
  if (shouldReload) {
    location.reload();
  }
};
...
}, 'WarpSpeed Desktop'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
  href: "https://packager.turbowarp.org/"
}, 'WarpSpeed Packager'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
  href: "https://docs.turbowarp.org/embedding"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  render() {
    ...
    // eslint-disable-next-line max-len
    , {
      defaultMessage: "{APP_NAME} is a fork of turbowarp to be for animators and artist. for animators by animators! if you have any problems then please visit @brickplex and ask your question)",
